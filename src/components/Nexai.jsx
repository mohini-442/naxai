...
const Nexai = () => {
    return (
        <>
            <div className='bg-[url(./assets/images/Frame3.png)] bg-center bg-size bg-no-repeat border border-white rounded-[24px] max-w-[1320px] lg:mx-auto py-[32px] px-[12px] lg:p-[163px_119px_124px_100px] m-[12px] relative z-[2]' data-aos="fade-up"
     data-aos-duration="3000">
                <div className='flex lg:flex-row flex-wrap -mx-3 flex-col-reverse '>
                    ...
                    <div className='lg:w-6/12 mx-auto px-3 relative flex justify-center items-center'>
