            ...
            <div className='overflow-hidden'>
                <div className=' bg-[url(./assets/images/footerbg.png)] bg-cover lg:bg-size bg-center bg-no-repeat'>
                    <div className='relative z-[2]'>
                        <div className='max-w-[1320px] mx-auto px-3 md:pt-32 pb-5'>
                            <div className='flex flex-row flex-wrap -mx-3 '>
                                <div className='lg:w-8/12 w-full px-3 pt-9'>
                                    ...
                                    <div className='flex items-center gap-3 pt-4'>
                                        <span className='cursor-pointer duration-[0.5s] hover:translate-y-[-10%]'><svg width="38" height="39" viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='lg:w-4/12 w-full px-3 pt-9 lg:pt-0'>
                        ...
                        <div className='w-[228px] h-[228px] bg-[#02CDCF] blur-[194px] absolute top-[2%] right-[-8%] z-[-1] hidden md:block'></div>
                    </div>
                </div>
            </div>
        </>
