            ...
            <div className='relative z-[2] overflow-hidden' id='roadmap'>
                <div className='py-20 max-w-[1320px] mx-auto px-3' data-aos="fade-up"
                    ...
                    <div className='flex flex-wrap flex-row -mx-3 pt-12'>
                        <div className='lg:w-1/2 px-3 w-full flex justify-center mix-blend-hue '>
                            {/* <div className='relative after:w-full after:h-full after:absolute after:top-0 after:left-0 after:bg-[#02CDCF] before:w-full before:h-full before:absolute before:top-0 before:left-0 before:bg-[#02CDCF] z-[-1] mix-blend-hue after:mix-blend-hue'> */}
                                    <img src={roadmap} alt="roadmap" className='w-[80%] mix-blend-lighten' />
                                {/* </div> */}
                        </div>
                            ...
                            <div className='h-[512px] overflow-y-scroll'>
                                <div className='relative z-[2] after:bg-[#02CDCF] after:rounded-[20px] after:h-full after:w-[6px] after:top-[10px] after:left-[10px] after:z-[-1] after:absolute'>
                                    <div className='flex gap-5 md:gap-16 items-center'>
                                        ...
                                        <div className=''>
                                            <h2 className='ff-recharge font-bold text-[22px] md:text-[24px] text-white'>Purchasing Nexai Products</h2>
                                            <p className='font-normal text-[14px] md:text-[16px] font-poppins text-[#B4B8B8] pt-2 md:pt-4'>Nex AI tokens will be the primary currency for acquiring Nexai's extensive range of software solutions, hardware devices, including drones and sensors, and other smart home products available on the Nexai marketplace. Users can confidently make purchases using Nex tokens, enjoying the convenience and flexibility of a token-based payment system.</p>
                                        </div>
                                    </div>
                                    <div className='flex gap-5 md:gap-16 items-center'>
                                        <div>
                                        ...
                                        <div>
                                            <h2 className='ff-recharge font-bold text-[22px] md:text-[24px] text-white pt-16'>Accessing Exclusive Content</h2>
                                            <p className='font-normal text-[14px] md:text-[16px] font-poppins text-[#B4B8B8] pt-2 md:pt-4'>By holding Nex AI tokens, users will gain privileged access to exclusive content within the Nexai platform. These tokens will unlock premium features, advanced functionalities, and specialized services, enabling users to fully explore and enjoy the enhanced capabilities of Nexai's ecosystem.</p>
                                        </div>
                                    </div>
                                    <div className='flex gap-5 md:gap-16 items-center'>
                                        <div>
                                        ...
                                        <div>
                                            <h2 className='ff-recharge font-bold text-[22px] md:text-[24px] text-white pt-16'>Loyalty and Rewards</h2>
                                            <p className='font-normal text-[14px] md:text-[16px] font-poppins text-[#B4B8B8] pt-2 md:pt-4'>The Nexai ecosystem will feature a robust loyalty program, rewarding users with Nex AI tokens for their active engagement, ongoing participation, and dedicated usage of Nexai's products and services. Token holders will have the opportunity to redeem their accumulated rewards for discounts, incentives, or exclusive offers, fostering a strong sense of loyalty and encouraging continued involvement.</p>
                                        </div>
                                    </div>
                                    <div className='flex gap-5 md:gap-16 items-center'>
                                        <div>
                                    ...
                                    <div className='flex gap-5 md:gap-16 items-center'>
                                        ...
                                        <div>
                                            <h2 className='ff-recharge font-bold text-[22px] md:text-[24px] text-white pt-16'>Token Staking and Rewards</h2>
                                            <p className='font-normal text-[14px] md:text-[16px] font-poppins text-[#B4B8B8] pt-2 md:pt-4'>Nex AI tokens will support staking mechanisms, allowing users to lock up their tokens for a specified period. By staking their tokens, users will earn additional rewards, such as interest, dividends, or other incentives, further incentivizing token holding and fostering long-term engagement and loyalty.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
