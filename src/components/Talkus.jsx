            ...
            <div className='relative z-[2]'>
                <div className='max-w-[1320px] px-3 mx-auto pt-16 md:pt-28 pb-12'>
                    <div className='flex flex-wrap flex-row -mx-3'>
                        ...
                        <div className='md:w-1/2 w-full px-3 flex md:justify-end justify-center pt-9 md:pt-0 items-center'>
                            <Button name='h-[58px]' btn='Get Started' />
                        </div>
                    </div>
                </div>
                <div className='w-[228px] h-[228px] bg-[#02CDCF] blur-[194px] absolute top-[2%] left-[-12%] z-[-1]'></div>
                <img src={frame2} alt="frame2" className='absolute top-[-22%] right-0 z-[-1] opacity-[20%]' />
            </div>
        </>
    )
}
